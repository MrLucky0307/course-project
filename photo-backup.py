...
class YaDisk:
    ...
    def save_photo(self):
        ...
        photo_name = ilya.get_photo_names()
        photo_url = ilya.get_url_max_size_photos()
...
ilya = VkUser(token_VK, '5.131')

ilya.get_profile_info()
ilya.get_profile_photos()
ilya.create_photo_dict()
disk.save_photo()
